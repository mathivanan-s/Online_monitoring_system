...
public class MacWarpActivity extends Activity {
    ...
    private void authenticate(){
        final ProgressDialog progressdialog = new ProgressDialog(MacWarpActivity.this);
        progressdialog.setMessage("Loading...");
        progressdialog.show();

        RestAdapter adapter = new RestAdapter.Builder()
                .setEndpoint(Utilities.getCurrentIp(false, MacWarpActivity.this))
                .build();

        CoreApis api = adapter.create(CoreApis.class);
        api.currentstatusreport("stop2",new Callback<MacRunningStatusResponse>() {
            ...
            public void success(MacRunningStatusResponse macRunningStatusResponse, Response response) {
                ...
                TableRow trow1=new TableRow(MacWarpActivity.this);
                trow1.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));

                TextView a1=new TextView(MacWarpActivity.this);
                a1.setTextSize(18);
                ...
                TextView a2=new TextView(MacWarpActivity.this);
                a2.setTextSize(18);
                ...
                TextView a3=new TextView(MacWarpActivity.this);
                a3.setTextSize(18);
                ...
                TextView a4=new TextView(MacWarpActivity.this);
                a4.setTextSize(18);
                ...
                TextView a5=new TextView(MacWarpActivity.this);
                a5.setTextSize(18);
                ...
                final View vline11 = new View(MacWarpActivity.this);
                ...
                while(i<Machine_length)
                {
                    ...
                    final TableRow trow=new TableRow(MacWarpActivity.this);
                    trow.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));
                    trow.setId(i);

                    final TextView b1=new TextView(MacWarpActivity.this);
                    b1.setTextSize(18);
                    ...
                    final TextView b2=new TextView(MacWarpActivity.this);
                    b2.setTextSize(18);
                    ...
                    final TextView b3=new TextView(MacWarpActivity.this);
                    b3.setTextSize(18);
                    ...
                    final TextView b4=new TextView(MacWarpActivity.this);
                    b4.setTextSize(18);
                    ...
                    final TextView b5=new TextView(MacWarpActivity.this);
                    b5.setTextSize(18);
                    ...
                    final View vline1 = new View(MacWarpActivity.this);
            ...
            public void failure(RetrofitError cause) {
                if (cause.getResponse() == null) {
                    Toast.makeText(MacWarpActivity.this, "Server Request Timeout", Toast.LENGTH_SHORT).show();
                }
