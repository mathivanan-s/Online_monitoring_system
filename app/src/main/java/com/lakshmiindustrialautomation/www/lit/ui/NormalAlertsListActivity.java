...
public class NormalAlertsListActivity extends AppCompatActivity {

    public Integer id;
    public String title, body;
    DatabaseHelper databaseHelper;
    public static NormalAlertsListActivity instance;
    TextView empty_notification_text;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_normal_alerts);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!adapter.isEmpty()) {
                    final ProgressDialog progressdialog = new ProgressDialog(NormalAlertsListActivity.this);
                    ...
                    new android.os.Handler().postDelayed(
                            new Runnable() {
                                public void run() {
                                    Toast.makeText(NormalAlertsListActivity.this, "Notifications deleted successfully", Toast.LENGTH_SHORT).show();
                                    progressdialog.dismiss();
                                }
                            }, 1500);
                }
                else {
                    Toast.makeText(NormalAlertsListActivity.this, "No notifications found", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(NormalAlertsListActivity.this, MainActivity.class);
        startActivity(intent);
    }

    public void fetchData(NormalAlertsArrayAdapter adapter){
        Cursor cursor;
        cursor = databaseHelper.getAllAlerts(DatabaseHelper.FIRST_TABLE_NAME);
