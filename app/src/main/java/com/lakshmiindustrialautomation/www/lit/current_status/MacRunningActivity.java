...
public class MacRunningActivity extends Activity {
    ...
    private void authenticate(){
        final ProgressDialog progressdialog = new ProgressDialog(MacRunningActivity.this);
        progressdialog.setMessage("Loading...");
        progressdialog.show();

        RestAdapter adapter = new RestAdapter.Builder()
                .setEndpoint(Utilities.getCurrentIp(false, MacRunningActivity.this))
                .build();
        ...
        api.currentstatusreport("running",new Callback<MacRunningStatusResponse>() {
            ...
            public void success(MacRunningStatusResponse macRunningStatusResponse, Response response) {
                ...
                TableRow trow1=new TableRow(MacRunningActivity.this);
                trow1.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));

                TextView a1=new TextView(MacRunningActivity.this);
                a1.setTextSize(18);
                ...
                TextView a2=new TextView(MacRunningActivity.this);
                a2.setTextSize(18);
                ...
                TextView a3=new TextView(MacRunningActivity.this);
                a3.setTextSize(18);
                ...
                TextView a4=new TextView(MacRunningActivity.this);
                a4.setTextSize(18);
                ...
                TextView a5=new TextView(MacRunningActivity.this);
                a5.setTextSize(18);
                ...
                final View vline11 = new View(MacRunningActivity.this);
                ...
                while(i<Machine_length)
                {
                    ...
                    final TableRow trow=new TableRow(MacRunningActivity.this);
                    trow.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));
                    trow.setId(i);

                    final TextView b1=new TextView(MacRunningActivity.this);
                    b1.setTextSize(18);
                    ...
                    final TextView b2=new TextView(MacRunningActivity.this);
                    b2.setTextSize(18);
                    ...
                    final TextView b3=new TextView(MacRunningActivity.this);
                    b3.setTextSize(18);
                    ...
                    final TextView b4=new TextView(MacRunningActivity.this);
                    b4.setTextSize(18);
                    ...
                    final TextView b5=new TextView(MacRunningActivity.this);
                    b5.setTextSize(18);
                    ...
                    final View vline1 = new View(MacRunningActivity.this);
            ...
            public void failure(RetrofitError cause) {
                if (cause.getResponse() == null) {
                    Toast.makeText(MacRunningActivity.this, "Server Request Timeout", Toast.LENGTH_SHORT).show();
                }
