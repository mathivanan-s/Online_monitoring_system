    ...
    private  void showcolorPickerDialog(final int item){
        ...
        colorPickerDialog.setOnColorChangedListener(new ColorPickerDialog.OnColorChangedListener() {
            ...
            public void onColorChanged(int i) {
                ...
                Utilities.storeSelectedColor(ColorPickerActivity.this, String.valueOf(color),item);

                select_color1.setBackgroundColor(Integer.parseInt(Utilities.getSelectedColor(ColorPickerActivity.this,1)));
                select_color2.setBackgroundColor(Integer.parseInt(Utilities.getSelectedColor(ColorPickerActivity.this,2)));
                select_color3.setBackgroundColor(Integer.parseInt(Utilities.getSelectedColor(ColorPickerActivity.this,3)));
                select_color4.setBackgroundColor(Integer.parseInt(Utilities.getSelectedColor(ColorPickerActivity.this,4)));
                select_color5.setBackgroundColor(Integer.parseInt(Utilities.getSelectedColor(ColorPickerActivity.this,5)));
                select_color6.setBackgroundColor(Integer.parseInt(Utilities.getSelectedColor(ColorPickerActivity.this,6)));
