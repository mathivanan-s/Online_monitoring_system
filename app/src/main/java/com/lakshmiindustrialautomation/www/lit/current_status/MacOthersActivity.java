...
public class MacOthersActivity extends Activity {
    ...
    private void authenticate(){
        final ProgressDialog progressdialog = new ProgressDialog(MacOthersActivity.this);
        progressdialog.setMessage("Loading...");
        progressdialog.show();

        RestAdapter adapter = new RestAdapter.Builder()
                .setEndpoint(Utilities.getCurrentIp(false, MacOthersActivity.this))
                .build();

        CoreApis api = adapter.create(CoreApis.class);
        api.currentstatusreport("ostop",new Callback<MacRunningStatusResponse>() {
            ...
            public void success(MacRunningStatusResponse macRunningStatusResponse, Response response) {
                ...
                TableRow trow1=new TableRow(MacOthersActivity.this);
                trow1.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));

                TextView a1=new TextView(MacOthersActivity.this);
                a1.setTextSize(18);
                ...
                TextView a2=new TextView(MacOthersActivity.this);
                a2.setTextSize(18);
                ...
                TextView a3=new TextView(MacOthersActivity.this);
                a3.setTextSize(18);
                ...
                TextView a4=new TextView(MacOthersActivity.this);
                a4.setTextSize(18);
                ...
                TextView a5=new TextView(MacOthersActivity.this);
                a5.setTextSize(18);
                ...
                final View vline11 = new View(MacOthersActivity.this);
                ...
                while(i<Machine_length)
                {
                    ...
                    final TableRow trow=new TableRow(MacOthersActivity.this);
                    trow.setLayoutParams(new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));
                    trow.setId(i);

                    final TextView b1=new TextView(MacOthersActivity.this);
                    b1.setTextSize(18);
                    ...
                    final TextView b2=new TextView(MacOthersActivity.this);
                    b2.setTextSize(18);
                    ...
                    final TextView b3=new TextView(MacOthersActivity.this);
                    b3.setTextSize(18);
                    ...
                    final TextView b4=new TextView(MacOthersActivity.this);
                    b4.setTextSize(18);
                    ...
                    final TextView b5=new TextView(MacOthersActivity.this);
                    b5.setTextSize(18);
                    ...
                    final View vline1 = new View(MacOthersActivity.this);
            ...
            public void failure(RetrofitError cause) {
                if (cause.getResponse() == null) {
                    Toast.makeText(MacOthersActivity.this, "Server Request Timeout", Toast.LENGTH_SHORT).show();
                }
